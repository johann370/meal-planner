...
| Databases as persistent storage | introduced | 2026-08-13 | 2026-08-14 | Own words, re: relational shape of the data: "since there a lot of links/relationships in the data for my app, a relational database...would be better". Reinforced 8/14: built `backend/index.js`'s data as an explicitly *in-memory* array, resets-on-restart concept now concrete (not yet contrasted hands-on with real persistence — that's Section 5) |
